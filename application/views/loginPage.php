...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('<?= base_url('assets/') ?>image/assets_toko/login_background_5');
            }

            [data-bs-theme="dark"] body {
                background-image: url('<?= base_url('assets/') ?>assets/media/auth/bg4-dark.jpg');
            }
        </style>
        <!--end::Page bg image-->
        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            ...
            <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
                <!--begin::Card-->
                <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20 border border-<?php
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" action="<?= base_url('login') ?>" method="post">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Your account company</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group=-->
                            ...
                            <div class="d-grid mb-10">
                                ...
                                <?php
                                if ($this->session->flashdata('error')) {
                                    echo '<div class=" text-danger text-center fw-semibold fs-6">*Username atau kata sandi salah</div>';
                                }
                                ?>
                            </div>
                            <!--end::Submit button-->
                            <!--begin::Sign up-->
                            <div class="text-gray-500 text-center fw-semibold fs-6">Make your work easy
                            </div>
                            <!--end::Sign up-->
                        </form>
                        <!--end::Form-->
